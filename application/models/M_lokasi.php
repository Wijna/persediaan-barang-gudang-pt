...
{
    var $table          = 'tbl_lokasi_barang';
    var $column_order   = array(null, 'id_lokasi', 'nama_lokasi', null);
    var $column_search  = array('id_lokasi', 'nama_lokasi');
    var $order = array('id_lokasi' => 'asc');
