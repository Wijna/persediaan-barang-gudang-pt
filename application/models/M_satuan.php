...
{
    var $table          = 'tbl_satuan_barang';
    var $column_order   = array(null, 'id_satuan', 'nama_satuan', null);
    var $column_search  = array('id_satuan', 'nama_satuan');
    var $order = array('id_satuan' => 'asc');
