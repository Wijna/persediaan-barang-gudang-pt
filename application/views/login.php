...
<head>
    ...
    <title>Login Aplikasi Persediaan Barang Gudang</title>
            ...
            <div class="col-md-4 col-sm-12 offset-md-4">
                <div class="jumbotron py-3 pt-4">
                    ...
                    <div class="form-group float-right">
                        <button type="submit" name="submit" value="submit" class="btn btn-warning text-white btn-sm">Log in <i class="fa fa-sign-in"></i></button>
                    </div>
