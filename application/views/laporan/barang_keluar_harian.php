...
<div class="row">
    ...
    <div class="col-md-2 col-sm-12">
        <a href="<?= site_url('barang_keluar_harian/' . date('Y-m-d', strtotime(str_replace('/', '-', $tanggal)))); ?>" class="btn btn-success btn-block btn-sm" target="_blank">
            <i class="fa fa-print"></i> Cetak Laporan
        </a>
        <a href="<?= site_url('barang_keluar_harian/export_excel/' . date('Y-m-d', strtotime(str_replace('/', '-', $tanggal)))); ?>" class="btn btn-info btn-block btn-sm" target="_blank">
        ...
        if ($data->num_rows() > 0) {
            ...
            foreach ($data->result() as $dt) {
                ...
                if ($row == 1) :
                    ...
                    echo '<td rowspan="' . $dt->row . '">' . $dt->id_barang_keluar . '</td>';
