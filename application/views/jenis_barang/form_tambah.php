...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-cubes"></i> Tambah Jenis Barang</h4>
    </div>
</div>
<hr class="mt-0" />
<?= form_open(); ?>
<div class="col-md-8">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('nama_jenis')) ? 'is-invalid' : ''; ?>" id="nama_jenis" name="nama_jenis" placeholder="Nama Jenis" value="<?= set_value('nama_jenis'); ?>">
