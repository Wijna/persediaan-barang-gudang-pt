...
<p class="text-muted display-5 mt-1 mb-2">#<?= $d->id_barang_masuk; ?> ( <?= tanggal_indo($d->tgl_barang_masuk); ?> )</p>
...
<button type="button" onclick="window.location.replace('<?= site_url('data_barang_masuk'); ?>')" class="btn btn-light btn-sm">Kembali</button>
</div>