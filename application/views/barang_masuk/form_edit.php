...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Edit Data Barang Masuk</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<?= form_open(); ?>
<input type="hidden" name="idP" value="<?= $fdata->id_barang_masuk; ?>">
<div class="col-md-12">
    <div class="form-group row">
        <label for="tanggal" class="col-sm-2 col-form-label">Tanggal Barang Masuk</label>
        <div class="col-sm-3">
            <input type="text" class="form-control form-control-sm <?= (form_error('tanggal')) ? 'is-invalid' : ''; ?>" name="tanggal" id="date-picker" value="<?= (set_value('tanggal')) ? set_value('tanggal') : date('d/m/Y', strtotime($fdata->tgl_barang_masuk)); ?>">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="number" class="form-control form-control-sm" min="1" id="jumlahx" placeholder="Jumlah Beli">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="col-sm-4 offset-sm-8">
        ...
        <button type="button" onclick="window.location.replace('<?= site_url('data_barang_masuk'); ?>')" class="btn btn-light btn-sm">
            Kembali
        </button>
    </div>
</div>
